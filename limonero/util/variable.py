...
from limonero.models import DataSourceVariable
...
def handle_variables(
    ...
    custom_vars: typing.List[DataSourceVariable] = None,
) -> None:
    """
    ...
    if custom_vars:
        for variable in custom_vars:
            var_value = variable.default_value
            date_value = _parse_date(var_value)
            if date_value:
                var_value = date_value
